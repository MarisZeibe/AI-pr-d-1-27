...
def choose_starting_player() -> Player:
    while True:
        ...
        if choice == "l":
            ...
            print("Nepareiza izvēle. Mēģiniet vēlreiz.", end='')
    ...
    while True:
        try:
            ...
            if input_number in number_range:
                ...
                print('Nepareizs skaitlis, mēģiniet vēlreiz: ', end='')
        except ValueError:
...
while True:
    ...
    while number < 3000:
        ...
        player = Player.USER if player == Player.COMPUTER else Player.COMPUTER
